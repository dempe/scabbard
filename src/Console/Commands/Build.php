...
class Build extends Command
{
  ...
  public function __construct(protected FrontMatterParser $frontMatterParser, protected Fingerprinter $fingerprinter)
  {
    parent::__construct();
  }
  ...
  protected function buildSite()
  {
    ...
    $this->fingerprinter->fingerprint(
      $outputPath,
      fn (string $message) => $this->info($this->timestampPrefix() . $message),
      fn (string $message) => $this->error($this->timestampPrefix() . $message)
    );
